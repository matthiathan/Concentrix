  ...
  return (
    <main className="auth-screen">
      <section className="auth-card">
        ...
        <p className="auth-copy">Sign in with an authorised account. Access is controlled by Supabase Authentication, organisation memberships and database Row Level Security.</p>
